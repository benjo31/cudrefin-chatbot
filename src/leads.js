...
const ADMIN_URL = 'https://cudrefin-chatbot.onrender.com';
...
export async function sendNotification({ botName, type, details }) {
  ...
  // Une fois cudrefin.ch vérifié sur Resend, communication@cudrefin.ch fonctionnera aussi
  ...
  if (type === 'lead') {
    ...
    html = `
      ...
      <p style="color:#888;font-size:12px">Envoyé automatiquement par Commune de Cudrefins</p>
    `;
  ...
  await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'Commune de Cudrefins <onboarding@resend.dev>',
      to,
      subject,
      html,
    }),
